...
function renderTrafficSorted() {
  ...
  if(toolsGrid){
    ...
    const landingTools=toolLimit>0?sortByTraffic(DATA.tools).slice(0,toolLimit):sortByTraffic(DATA.tools);
